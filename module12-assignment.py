...
def analyze_sales_correlations():
    ...
    top_correlations = list(sales_corr.items())[1:6]
...
def develop_recommendations():
    return [
        ...
        "Expand Prepared Foods and Produce departments due to higher margins",
        "Improve efficiency in low-performing stores like Gainesville",
        "Increase marketing spend where ROI is strongest",
        "Target high-value customer segments such as Family Shoppers and Gourmet Cooks"
    ]
...
def generate_executive_summary():
    print("\nOverview:")
    print("GreenGrocer’s performance shows strong variation across stores. "
          "Sales are influenced by store size, staffing, and seasonal demand.")

    print("\nKey Findings:")
    print("- Miami and Tampa lead in overall sales")
    print("- Prepared Foods and Produce generate the highest revenue")
    print("- Customer segments differ in spending behavior")
    print("- Seasonal peaks occur in summer and month of December")

    print("\nRecommendations:")
    print("- Invest more in the high-performing stores")
    print("- Expand high-margin departments")
    print("- Improve efficiency in weaker stores")
    print("- Focus on marketing to ensure higher sales")

    print("\nExpected Impact:")
    print("Implementing these strategies can improve profitability and resource allocation, "
          "and increase long-term growth across all store locations.")
